...
return new class extends Migration
{
    ...
    {
        Schema::create('tbl_data_analytics', function (Blueprint $table) {
            $table->id();
            ...
            $table->foreign('evaluation_id')->references('id')->on('tbl_saved_evaluation');
            $table->timestamps();
        });
    }
    ...
    {
        Schema::dropIfExists('tbl_data_analytics');
    }
};
