...
<html :class="{ 'theme-dark': dark }" x-data="data()" lang="en">
  ...
  <body>
    ...
    ->pluck('teacher_id');
          ...
          if($teach->teacher_suffix==='none'){
            $finalSuffix= '';
          }else{
            $finalSuffix = $teach->teacher_suffix;
          }
            $fullname= $teach->teacher_first_name. " ". substr($teach->teacher_middle_name, 0, 1). ". ". $teach->teacher_last_name. " ". $finalSuffix;
