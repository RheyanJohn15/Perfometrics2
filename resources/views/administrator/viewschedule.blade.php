     ...
     <div class="w-full mb-8 overflow-hidden rounded-lg shadow-xs">
        <div class="w-full overflow-x-auto">
          <table class="w-full whitespace-no-wrap">
            ...
            @php
                $class= App\Models\Section::where('id', $SchedTeachers->sched_class_name)->first();
                $className= $class->year_level. "-" .App\Models\Strand::where('id', $class->strand_id)->first()->strand_shortcut. " - ". $class->section;
            @endphp
          ...
          <table class="w-full whitespace-no-wrap">
            ...
            <tr class="text-gray-700 dark:text-gray-400">
                <td class="px-4 py-3 text-sm">
                   ...
                   $class= App\Models\Section::where('id', $schedRoom->sched_class_name)->first();
                $className= $class->year_level. "-" .App\Models\Strand::where('id', $class->strand_id)->first()->strand_shortcut. " - ". $class->section;
                    @endphp
               {{$teacherFullName}}
              </td>
