  ...
  <body>
    ...
    >
      ...
      <div class="flex flex-col flex-1">
        ...
        <div class="w-full flex flex-col justify-start" id="all">
         
   @foreach ($strands as $str)
          
      @php
  
    $students= App\Models\Student::where('student_strand', $str->id)->get();
  $s=1;
    @endphp
    @if ($students->count()===0)
    <h4 class="mt-8  text-center text-lg font-semibold text-gray-600 dark:text-gray-300">
        {{$str->strand_name}}
      </h4>
     <div class="w-full flex flex-col items-center justify-center border border-solid-gray-200 mb-4">
        <i class="fa-solid fa-face-frown mt-4 text-gray-400 dark:text-gray-200" style="font-size: 4rem"></i>
        <p class="text-gray-400 dark:text-gray-200 mb-4">No Students Registered on this strand</p>
     </div>

    @else
 
    <h4 class="mt-8 text-lg text-center font-semibold text-gray-600 dark:text-gray-300">
        {{$str->strand_name}}
      </h4>
        ...
        <div class="w-full overflow-x-auto">
          <table class="w-full ">
            <thead>
              ...
              >
                <th class="px-4 py-3" style="width: 40%">Student Name</th>
                <th class="px-4 py-3" style="width: 20%">LRN</th>
                <th class="px-4 py-3" style="width: 20%">Password</th>
                <th class="px-4 py-3" style="width: 20%">Year Level</th>
