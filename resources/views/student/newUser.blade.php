<div class="bgNewUser dark:bg-gray-800 overflow-x-auto mb-8" id="bgNewUser"  >
    <div id="starting" class="w-full h-full starting">
     ...
     <h3 id="firstNew" class="firstNew mt-4 text-center text-6xl font-semibold text-gray-700 dark:text-gray-200">Hi!..{{$name}}</h3>
 ...
 $(document).ready(function() {
       $('form#step2Display').submit(function(event) {
           ...
           $.ajax({
               type: 'POST',
               url: '{{ route('studentVerificationMail') }}', // Set the route to handle the form submission
               data: formData,
...
function stopCountdown() {
 ...
 function SaveDataVerified() {
     ...
     $.ajax({
         type: 'POST',
         url: '{{route('studentSavedVerifiedData')}}',
         data: formData,
         success: function(response) {
