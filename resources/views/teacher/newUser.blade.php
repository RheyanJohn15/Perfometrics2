<div class="bgNewUser dark:bg-gray-800 overflow-x-auto mb-8" id="bgNewUser"  >
 ...
 <div class="flex mt-6 text-sm">
    ...
    <div id="finalGetStarted" style="display: none" class="passText overflow-x-auto">
 ...
 $(document).ready(function() {
       $('form#step2Display').submit(function(event) {
           ...
           $.ajax({
               type: 'POST',
               url: '{{ route('teacherVerificationMail') }}', // Set the route to handle the form submission
               data: formData,
...
function stopCountdown() {
 ...
 function SaveDataVerified() {
     ...
     $.ajax({
         type: 'POST',
         url:"{{route('teacherSavedVerifiedData')}}",
         data: formData,
         success: function(response) {
